...
#align(center)[
        ...
        #set text(size: 22pt)
        \ \ \ 
        Investigating Moroccan’s Interest in Adopting a New Written System  for Darija
        \ \
]
// Author and Info
#align(center)[
...
= Literature Review
        == Vocabulary
        Most of Darija's lexicon is from classical Arabic @Duri. Tamazight #footnote[Or Berber, a term we do not prefere to use] also played an important role in the developement of Darija @Chtatou. As well French and Spanish during the colonial period in Morocco @Burke.
        == Grammar
        Grammatical rules of Darija. @Chtatou
\ \
